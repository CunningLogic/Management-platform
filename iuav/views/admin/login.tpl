...
<div class="form-group field-loginform-password required">
<label class="col-lg-1 control-label" for="loginform-password">Verification code</label>
<div class="col-lg-3">{$CaptchaHtml}</div>
<div class="col-lg-8"><p class="help-block help-block-error">{$codeerror}</p></div>
</div>
