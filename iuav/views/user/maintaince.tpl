...
<body>
    ...
    <div class="page-container">
        {include "left_side.tpl" nav="maintaince"}
                            ...
                            <tbody>
                                ...
                                {if isset($data)}
                                    {foreach from=$data key="mykey" item=activedata}
                                        <tr>                                           
                                            <td>{$activedata.CASENO|escape:"html"}</td>
                                            <td>{$activedata.SN|escape:"html"}</td>
                                            <td>{$activedata.REMARK|escape:"html"}</td>
                                            <td>保外</td>
                                            <td>
                                               {$activedata.CASESTATUS|escape:"html"}
                                            </td>
                                            <td>
                                                <button type="button" class="button button-default" data-toggle="modal" data-target="#evaluateModal"
                                                        data-caseno="{$activedata.CASENO}" {if $activedata.evaluate} data-data={$activedata.evaluate}{/if}>
                                                    {if $activedata.evaluate}
                                                        查看评价
                                                    {else}
                                                        现在评价
                                                    {/if}
