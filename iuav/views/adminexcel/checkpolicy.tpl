...
<div class="site-login">
    ...
    <form id="login-form" class="form-horizontal" action="/adminexcel/checkpolicy" method="post" enctype="multipart/form-data" onsubmit="return loginSubmit();" >
    ...
    <table cellspacing="10" cellpadding="10" border="1" width="100%">    
        ...
        <tbody id="tbody">
           {foreach from=$listMark key="mykey" item=user}
           <tr>
            <td>{$user.A}</td>           
            <td><a href="/adminuser/listpolicies/?pol_no={$user.B}" target="_blank">{$user.B}</a></td>
            <td><a href="/adminuser/listpolicies/?order_id={$user.C}" target="_blank">{$user.C}</a></td>
